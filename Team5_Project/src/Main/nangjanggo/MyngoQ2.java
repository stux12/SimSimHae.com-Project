...
public class MyngoQ2 extends MyngoQ1 {

	private JPanel contentPane;
	static String MainJ3;
	...
	public MyngoQ2() {
		...
		comboBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "결과창을 확인해주세요");
				dispose();
				setVisible(false);
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"고추장", "고추가루", "간장","케찹"}));
